...
layui.use(['form','jquery',"layer"],function() {
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="'+ pageContext +'/images/logo.jpg" class="userAvatar"/></div>'+
                            '<div class="admin-header-lock-name">页面已锁定</div>'+
                            '<div class="input_btn">'+
    ...
    $("body").on("click","#unlock",function(){
        ...
        if(pwd == ''){
        	...
        	$.ajax({
                type : 'post',
                url :pageContext+"/login/pageDelocking?pwd="+pwd,
                date:{passWord:pwd},
                dataType: "json",
