layui.use(['form','layer','laydate','table','laytpl','element'],function(){
    ...
    var tableIns = table.render({
        elem: '#strokeList',
        url : parent.pageContext+'/Analyse/getAllStroke',
        cellMinWidth : 95,
        page : true,
        height : "full-150",
        limit : 10,
        ...
        cols : [[
            ...
            {field: 'analyseRequest', title: '总笔数',align:'center'},
            {title: '操作', width:100, templet:'#strokeListBar',fixed:"right",align:"center"}
    ...
    table.on('tool(strokeList)', function(obj){
        var layEvent = obj.event,
        data = obj.data;
        if(layEvent === 'detail'){
        	var tableIns = table.render({
                elem: '#strokeDetailList',
