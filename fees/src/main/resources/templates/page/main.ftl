...
<#elseif (s.fee-s.orgCost.forecast)< s.orgCost.forecast*5>
            ...
            <td width="100">
                <a class="layui-bg-green details" id="${s.id?c}" name="${s.name}_${s.orgNo}" href="javascript:void(0)">
...
<script type="text/javascript" src="${base.basePath}/js/maindatatable.js"></script>
